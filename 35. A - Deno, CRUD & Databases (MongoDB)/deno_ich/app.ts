...
// Importing the connect functionalty from our helper file:
import { connect } from "./helpers/db_client.ts";

// Then we open the connection to the DB before starting the app
await connect();
...
// This was not working for PUT and DELETE requests!!
